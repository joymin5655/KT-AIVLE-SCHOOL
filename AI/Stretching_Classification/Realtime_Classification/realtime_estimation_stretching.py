...
import pandas as pd
import time
from AI.Stretching_Classification.Data_Processing.preprocessing_stretching import calculate_distance, calculate_angle, process_images_from_folder, stretching_selected_landmarks, landmark_description

mp_holistic = mp.solutions.holistic

model = joblib.load('stretching_classification_model.pkl')
